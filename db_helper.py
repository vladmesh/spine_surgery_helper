...
class DBHelper:
    ...
    def create_tables(self):
        ...
        parameters = [
            ...
            (15, 'угол сегментарной деформации, образованный нижней кортикальной пластинкой тела \nвышележащего '
                 'позвонка и верхней кортикальной пластинкой тела нижележащего позвонка'),
            (16, 'переднее межтеловое расстояние (от переднего края нижней кортикальной пластинки \nтела вышележащего '
